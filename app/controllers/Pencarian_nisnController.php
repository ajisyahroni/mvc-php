<?php 
/**
 * Pencarian_nisn Page Controller
 * @category  Controller
 */
class Pencarian_nisnController extends SecureController{
	function __construct(){
		parent::__construct();
		$this->tablename = "Pencarian_NISN";
	}
	/**
     * Custom list page
     * @return BaseView
	...
	function index(){
		...
		$page_title = $this->view->page_title = "Pencarian Nisn";
		$this->view->report_filename = date('Y-m-d') . '-' . $page_title;
		$this->view->report_title = $page_title;
		$this->view->report_layout = "report_layout.php";
		$this->view->report_paper_size = "A4";
		$this->view->report_orientation = "portrait";
		$this->render_view("pencarian_nisn/list.php", $data); //render the full page
	}
}
