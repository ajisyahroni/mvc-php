...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Peserta SMA</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("peserta_sma/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-NISN"  value="<?php  echo $data['NISN']; ?>" type="text" placeholder="Enter NISN" list="NISN_list"  required="" name="NISN"  class="form-control " />
                                                    <datalist id="NISN_list">
                                                        <?php 
                                                        $NISN_options = $comp_model -> peserta_sma_NISN_option_list();
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                                <label class="control-label" for="Alergi">Alergi <span class="text-danger">*</span></label>
                                                            </div>
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-Alergi"  value="<?php  echo $data['Alergi']; ?>" type="text" placeholder="Enter Alergi"  required="" name="Alergi"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-SA"  value="<?php  echo $data['SA']; ?>" type="text" placeholder="Enter Nama SA"  name="SA"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
