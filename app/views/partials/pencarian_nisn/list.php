...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Pencarian Nisn</h4>
                </div>
                <div class="col-sm-3 comp-grid">
                    <form method="get" action="<?php print_link($current_page) ?>" class="form filter-form">
                        <form  class="search" action="<?php print_link('Pencarian_NISN/List'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('Pencarian_NISN'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="Pencarian_NISN-list-records">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-Anggota_tubuh"> Anggota Tubuh</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-id">
                                                    <a size="sm" class="btn btn-sm btn-primary page-modal" href="<?php print_link("peserta_uks/list/NISN/" . urlencode($data['NISN'])) ?>">
                                                        <i class="fa fa-eye"></i> <?php echo $data['id'] ?>
                                                    </a>
                                                </td>
                                                <td class="td-NISN"> <?php echo $data['NISN']; ?></td>
                                                ...
                                                <td class="td-TTL"> <?php echo $data['TTL']; ?></td>
                                                <td class="td-Alergi"> <?php echo $data['Alergi']; ?></td>
                                                <td class="td-Alamat"> <?php echo $data['Alamat']; ?></td>
                                                <td class="td-id_mcu"> <?php echo $data['id_mcu']; ?></td>
                                                <td class="td-Tanggal"> <?php echo $data['Tanggal']; ?></td>
                                                <td class="td-TB"> <?php echo $data['TB']; ?></td>
                                                <td class="td-BB"> <?php echo $data['BB']; ?></td>
                                                <td class="td-Goldar"> <?php echo $data['Goldar']; ?></td>
                                                <td class="td-Anggota_tubuh"> <?php echo $data['Anggota_tubuh']; ?></td>
                                                <td class="td-Masalah"> <?php echo $data['Masalah']; ?></td>
                                                <td class="td-Riwayat_kesehatan"> <?php echo $data['Riwayat_kesehatan']; ?></td>
                                                <td class="td-Subjective"> <?php echo $data['Subjective']; ?></td>
                                                <td class="td-Objective"> <?php echo $data['Objective']; ?></td>
                                                <td class="td-Assesment"> <?php echo $data['Assesment']; ?></td>
                                                <td class="td-Plan"> <?php echo $data['Plan']; ?></td>
                                            </tr>
                                            <?php 
                                            }
                                            ?>
